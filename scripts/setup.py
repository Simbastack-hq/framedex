...
default Whisper + insightface models so the first `vidx` run doesn't stall
...
def predownload_insightface() -> None:
    ...
    try:
        ...
        print("Workaround: pass --no-faces to vidx.")
        return False
...
def print_pyannote_instructions() -> None:
    print(
        ...
        --no-diarize to vidx and you'll still get full transcripts,
